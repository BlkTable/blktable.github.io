...
const A = load(APP,
  ...
  ['isFileField', 'isFileType', 'uploadCap', 'isVideoPath', 'isPlayableVideo', 'isImagePath', 'fileLabel', 'esc', 'filePaths', 'photoSectionHtml', 'fileTileHtml', 'fileAddTileHtml', 'coverHtml']);
